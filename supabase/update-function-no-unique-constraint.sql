-- Update function to work without unique constraint
-- This allows multiple uploads of the same file to create separate rows
-- Run this after removing the unique constraint
  ...
  ELSE
    ...
    IF v_existing_id IS NOT NULL THEN
      ...
      INTO 
        ...
        v_accuracy_rate_first_run, v_accuracy_rate_second_run, v_accuracy_rate_third_run, v_accuracy_rate_ai_guided_adjustments;
    ELSE
      -- No existing row found, create a new one (shouldn't happen for updates, but handle it)

-- Fix for ambiguous fund_id column reference error
...
BEGIN
  ...
  -- Upsert fund data - explicitly qualify column names to avoid ambiguity
  ...
  ON CONFLICT (fund_id, run_type) DO UPDATE
    SET 
      ...
      updated_at = NOW()
  RETURNING fund_data.fund_id, fund_data.saved_at INTO v_fund_id, v_saved_at;
